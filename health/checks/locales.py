...
Verifies that locale files (en.json, de.json, ko.json, bg.json, it.json, zh-TW.json) exist, are valid JSON,
...
class LocaleFileHealthCheck(HealthCheck):
    ...
    Checks:
    1. en.json, de.json, ko.json, bg.json, cs.json, it.json, and zh-TW.json files exist
