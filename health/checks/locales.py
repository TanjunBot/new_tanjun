...
Verifies that locale files (en.json, de.json, ko.json, bg.json, hr.json, it.json, zh-TW.json, da.json, id.json, zh-CN.json) exist, are valid JSON,
...
class LocaleFileHealthCheck(HealthCheck):
    ...
    Checks:
    1. en.json, de.json, ko.json, and zh-CN.json files exist
