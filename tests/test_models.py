...
class TestGiveawayModel:
    ...
    def test_from_row_wrong_field_count_raises(self):
...
class TestGiveawayBlacklistEntryModel:
    ...
    def test_from_row_without_reason(self):
...
class TestReportModel:
    ...
    def test_from_row_none_reason(self):
...
class TestTriggerMessageModel:
    ...
    def test_from_row_case_sensitive_false(self):
...
class TestTicketMessageModel:
    ...
    def test_from_row_none_optional_fields(self):
...
class TestTicketModel:
    ...
    def test_from_row_closed_ticket(self):
...
class TestAISituationModel:
    ...
    def test_from_row_extreme_float_values(self):
...
class TestWarningModel:
    ...
    def test_from_row_without_expiration(self):
        now = datetime.now()
...
class TestBlacklistEntryModel:
    ...
    def test_from_row_single_element(self):
        """reason has a default, so a 1-element tuple should work."""
...
class TestLogEnableModel:
    ...
    def test_from_row_all_true(self):
    ...
    def test_from_row_all_false(self):
        row = ("guild1",) + tuple([False] * 24)
        model = LogEnableModel.from_row(row)
        for key in LogEnableModel._OPTION_KEYS:
            assert getattr(model, key) is False

    def test_from_row_integer_values_cast_to_bool(self):
    ...
    def test_from_row_nonzero_integers_are_truthy(self):
    ...
    def test_from_row_empty_string_is_falsy(self):
    ...
    def test_get_option_valid_indices(self):
        row = ("guild1",) + tuple([True] * 24)
        model = LogEnableModel.from_row(row)
    ...
    def test_get_option_negative_index_wraps(self):
    ...
    def test_set_option_invalid_index_raises(self):
        row = ("guild1",) + tuple([True] * 24)
        model = LogEnableModel.from_row(row)
        with pytest.raises(IndexError):
            model.set_option(24, False)

    def test_set_option_stores_non_bool(self):
    ...
    def test_option_keys_match_field_names(self):
        row = ("guild1",) + tuple([False] * 24)
        model = LogEnableModel.from_row(row)
        for key in LogEnableModel._OPTION_KEYS:
            assert hasattr(model, key), f"Missing attribute: {key}"

    def test_option_keys_count(self):
    ...
    def test_from_row_too_long_still_works(self):
...
class TestChannelOverwriteModel:
    ...
    def test_from_row_complex_json(self):
    ...
    def test_from_row_numeric_values(self):
...
class TestDynamicSlowmodeModel:
    ...
    def test_from_row_with_cached_slowmode(self):
...
class TestWelcomeChannelModel:
    ...
    def test_from_row_null_optional_fields(self):
...
class TestLeaveChannelModel:
    ...
    def test_leave_channel_same_structure_as_welcome(self):
...
class TestLevelRoleModel:
    ...
    def test_from_row_level_zero(self):
...
class TestLevelLeaderboardEntryModel:
    ...
    def test_from_row_zero_xp(self):
...
class TestUserLevelInfoModel:
    ...
    def test_fields_none_background(self):
...
class TestTwitchOnlineNotificationModel:
    ...
    def test_from_row_without_message(self):
