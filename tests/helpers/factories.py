...
def giveaway_row(**overrides: int | tuple) -> tuple:
    base = (1, GUILD_ID, 'Test Giveaway', 'Description', 1, True, 'custom', 'sponsor', '10€', 'msg', _dt(), _dt(), True, False, 0, 0, 0, False, CHANNEL_ID, '55555555555555555', _dt())
    if not overrides:
        return base
    data = list(base)
...
def twitch_notification_row(guild_id: str=GUILD_ID, channel_id: str=CHANNEL_ID, twitch_username: str='teststreamer') -> tuple:
