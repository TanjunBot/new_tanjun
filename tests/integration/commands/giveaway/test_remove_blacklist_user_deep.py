...
@patch("commands.giveaway.remove_blacklist_user.giveaway_service.is_user_blacklisted", new_callable=AsyncMock, return_value=False)
...
@patch("commands.giveaway.remove_blacklist_user.giveaway_service.is_user_blacklisted", new_callable=AsyncMock, return_value=True)
