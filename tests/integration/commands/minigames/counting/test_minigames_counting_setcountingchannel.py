"""Integration tests for commands.minigames.counting.setcountingchannel.setCountingChannel."""
...
PROFILE = CommandProfile.from_module('commands.minigames.counting.setcountingchannel', 'setCountingChannel', 'info, channel=info.channel')
