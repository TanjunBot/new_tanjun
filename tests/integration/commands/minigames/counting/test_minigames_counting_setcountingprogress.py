"""Integration tests for commands.minigames.counting.setcountingprogress.setCountingProgress."""
...
PROFILE = CommandProfile.from_module('commands.minigames.counting.setcountingprogress', 'setCountingProgress', 'info, channel=info.channel, progress=5')
