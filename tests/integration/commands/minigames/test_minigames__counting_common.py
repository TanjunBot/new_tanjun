...
PROFILE = CommandProfile.from_module('commands.minigames._counting_common', 'require_moderate_members', 'info, locale_key_prefix="minigames.setcountingchallengeprogress"')
...
async def test_require_moderate_members_restricted(restricted_command_info):
    ...
    with profile_patches(PROFILE) as mocks:
        ...
        await command_fn(info, locale_key_prefix="minigames.setcountingchallengeprogress")
