"""Integration tests for commands.minigames.counting_modes.setcountingchannel.setCountingChannel."""
...
PROFILE = CommandProfile.from_module('commands.minigames.counting_modes.setcountingchannel', 'setCountingChannel', 'info, channel=info.channel')
...
async def test_setCountingChannel_restricted(restricted_command_info):
    ...
    with profile_patches(PROFILE) as mocks:
        from commands.minigames.counting_modes.setcountingchannel import setCountingChannel as command_fn
