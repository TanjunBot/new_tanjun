...
async def test_setCountingChannel_admin_paths(admin_command_info):
...
async def test_setCountingChannel_restricted_paths(restricted_command_info):
    from commands.minigames.counting_modes.setcountingchannel import setCountingChannel as command_fn
    try:
...
async def test_setCountingChannel_no_guild(restricted_command_info):
    from commands.minigames.counting_modes.setcountingchannel import setCountingChannel as command_fn
