"""Integration tests for commands.minigames.counting_modes.setcountingprogress.setCountingProgress."""
...
PROFILE = CommandProfile.from_module('commands.minigames.counting_modes.setcountingprogress', 'setCountingProgress', 'info, channel=info.channel, progress=5')
...
async def test_setCountingProgress_restricted(restricted_command_info):
    ...
    with profile_patches(PROFILE) as mocks:
        from commands.minigames.counting_modes.setcountingprogress import setCountingProgress as command_fn
