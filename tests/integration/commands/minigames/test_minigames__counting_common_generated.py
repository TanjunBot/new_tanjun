...
async def test_require_counting_channel_admin_paths(admin_command_info):
    ...
    try:
        await command_fn(admin_command_info, command_info=admin_command_info, channel_id=None, get_progress_func=None, locale_key_prefix=None)
    except Exception:
        pass
...
async def test_require_counting_channel_restricted_paths(restricted_command_info):
    from commands.minigames._counting_common import require_counting_channel as command_fn
    try:
        await command_fn(restricted_command_info, command_info=restricted_command_info, channel_id=None, get_progress_func=None, locale_key_prefix=None)
    except Exception:
        pass
