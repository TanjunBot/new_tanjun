"""Integration tests for commands.minigames.wordchain.removewordchainchannel.removewordchainchannel."""
...
PROFILE = CommandProfile.from_module('commands.minigames.wordchain.removewordchainchannel', 'removewordchainchannel', 'info, channel=info.channel')


async def test_removewordchainchannel_restricted(restricted_command_info):
...
async def test_removewordchainchannel_no_guild(no_guild_command_info):
...
async def test_removewordchainchannel_admin(admin_command_info):
