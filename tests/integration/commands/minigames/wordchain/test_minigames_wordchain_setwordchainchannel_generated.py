...
async def test_setwordchainchannel_admin_paths(admin_command_info):
...
async def test_setwordchainchannel_restricted_paths(restricted_command_info):
    from commands.minigames.wordchain.setwordchainchannel import setwordchainchannel as command_fn
    try:
...
async def test_setwordchainchannel_no_guild(restricted_command_info):
    from commands.minigames.wordchain.setwordchainchannel import setwordchainchannel as command_fn
