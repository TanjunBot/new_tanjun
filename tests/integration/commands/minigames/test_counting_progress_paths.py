...
@patch("commands.minigames.counting_challenge.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=True)
...
@patch("commands.minigames.counting_challenge.setcountingprogress.require_counting_channel", new_callable=AsyncMock, return_value=None)
@patch("commands.minigames.counting_challenge.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=False)
...
@patch("commands.minigames.counting_challenge.setcountingprogress.require_valid_progress", new_callable=AsyncMock, return_value=True)
@patch("commands.minigames.counting_challenge.setcountingprogress.require_counting_channel", new_callable=AsyncMock, return_value=1)
@patch("commands.minigames.counting_challenge.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=False)
...
@patch("commands.minigames.counting_challenge.setcountingprogress.require_valid_progress", new_callable=AsyncMock, return_value=False)
@patch("commands.minigames.counting_challenge.setcountingprogress.require_counting_channel", new_callable=AsyncMock, return_value=3)
@patch("commands.minigames.counting_challenge.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=False)
...
@patch("commands.minigames.counting_modes.setcountingprogress.require_valid_progress", new_callable=AsyncMock, return_value=False)
@patch("commands.minigames.counting_modes.setcountingprogress.require_counting_channel", new_callable=AsyncMock, return_value=1)
@patch("commands.minigames.counting_modes.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=False)
...
@patch("commands.minigames.counting_modes.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=True)
async def test_modes_set_progress_no_perm(mock_mod, admin_command_info):
    channel = make_text_channel(guild=admin_command_info.guild)
    await setModesProgress(admin_command_info, channel, 1)


@patch("commands.minigames.counting_modes.setcountingprogress.require_counting_channel", new_callable=AsyncMock, return_value=None)
@patch("commands.minigames.counting_modes.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=False)
...
@patch("commands.minigames.counting_modes.setcountingprogress.require_valid_progress", new_callable=AsyncMock, return_value=True)
@patch("commands.minigames.counting_modes.setcountingprogress.require_counting_channel", new_callable=AsyncMock, return_value=1)
@patch("commands.minigames.counting_modes.setcountingprogress.require_moderate_members", new_callable=AsyncMock, return_value=False)
