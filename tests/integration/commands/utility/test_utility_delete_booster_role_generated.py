...
async def test_deleteBoosterRole_admin_paths(admin_command_info):
...
async def test_deleteBoosterRole_restricted_paths(restricted_command_info):
    from commands.utility.delete_booster_role import deleteBoosterRole as command_fn
...
async def test_deleteBoosterRole_no_guild(restricted_command_info):
    from commands.utility.delete_booster_role import deleteBoosterRole as command_fn
