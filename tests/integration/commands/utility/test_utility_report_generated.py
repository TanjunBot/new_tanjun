...
async def test_report_admin_paths(admin_command_info):
    ...
    try:
        await command_fn(admin_command_info, command_info=admin_command_info, reason="valid reason here", user=make_target_member())
    except Exception:
        pass
...
async def test_report_restricted_paths(restricted_command_info):
    from commands.utility.report import report as command_fn
    try:
        await command_fn(restricted_command_info, command_info=restricted_command_info, reason="valid reason here", user=make_target_member())
    except Exception:
        pass
