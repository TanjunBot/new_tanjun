...
async def test_battlelog_admin_paths(admin_command_info):
    from commands.utility.brawlstars.battlelog import battlelog as command_fn
    try:
...
async def test_battlelog_restricted_paths(restricted_command_info):
    from commands.utility.brawlstars.battlelog import battlelog as command_fn
    try:
...
async def test_battlelog_no_guild(restricted_command_info):
    from commands.utility.brawlstars.battlelog import battlelog as command_fn
