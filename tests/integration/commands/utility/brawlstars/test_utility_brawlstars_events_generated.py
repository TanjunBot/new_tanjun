...
async def test_events_admin_paths(admin_command_info):
    from commands.utility.brawlstars.events import events as command_fn
    try:
...
async def test_events_restricted_paths(restricted_command_info):
    from commands.utility.brawlstars.events import events as command_fn
    try:
...
async def test_events_no_guild(restricted_command_info):
    from commands.utility.brawlstars.events import events as command_fn
