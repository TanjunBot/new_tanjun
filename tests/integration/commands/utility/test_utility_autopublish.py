"""Integration tests for commands.utility.autopublish.autopublish."""
...
PROFILE = CommandProfile.from_module('commands.utility.autopublish', 'autopublish', 'info, channel=info.channel')


async def test_autopublish_restricted(restricted_command_info):
...
async def test_autopublish_no_guild(no_guild_command_info):
...
async def test_autopublish_admin(admin_command_info):
