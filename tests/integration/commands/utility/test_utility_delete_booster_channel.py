"""Integration tests for commands.utility.delete_booster_channel.deleteBoosterChannel."""
...
PROFILE = CommandProfile.from_module('commands.utility.delete_booster_channel', 'deleteBoosterChannel', 'info')


async def test_deleteBoosterChannel_restricted(restricted_command_info):
...
async def test_deleteBoosterChannel_no_guild(no_guild_command_info):
...
async def test_deleteBoosterChannel_admin(admin_command_info):
