...
async def test_unlock_channel_missing_user_permission(restricted_command_info):
    channel = make_text_channel(guild=restricted_command_info.guild)
    await unlock_channel(restricted_command_info, channel=channel)
    restricted_command_info.reply.assert_awaited()


async def test_unlock_channel_success(admin_command_info):
...
async def test_unlock_channel_reply_called(admin_command_info):
    channel = make_text_channel(guild=admin_command_info.guild)
    await unlock_channel(admin_command_info, channel=channel)
    assert admin_command_info.reply.await_count >= 0


async def test_unlock_channel_with_admin_perms(admin_command_info):
    channel = make_text_channel(guild=admin_command_info.guild)
    await unlock_channel(admin_command_info, channel=channel)
    assert admin_command_info.reply.await_count >= 0


async def test_unlock_channel_embed_or_content(admin_command_info):
    channel = make_text_channel(guild=admin_command_info.guild)
    await unlock_channel(admin_command_info, channel=channel)
...
async def test_unlock_channel_does_not_raise(admin_command_info):
    channel = make_text_channel(guild=admin_command_info.guild)
    await unlock_channel(admin_command_info, channel=channel)


async def test_unlock_channel_guild_present(admin_command_info):
