...
@patch("commands.image.compress.ImageService.validate_attachment", return_value="typenotsupported")
...
@patch("commands.image.mirror.ImageService.validate_attachment", return_value="filesize")
...
@patch("commands.image.rescale.ImageService.validate_attachment", return_value="typenotsupported")
...
@patch("commands.image.background.ImageService.validate_attachment", return_value="typenotsupported")
