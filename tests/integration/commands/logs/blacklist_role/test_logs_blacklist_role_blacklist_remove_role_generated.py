...
async def test_blacklist_remove_role_admin_paths(admin_command_info):
...
async def test_blacklist_remove_role_restricted_paths(restricted_command_info):
    from commands.logs.blacklist_role.blacklist_remove_role import blacklist_remove_role as command_fn
...
async def test_blacklist_remove_role_no_guild(restricted_command_info):
    from commands.logs.blacklist_role.blacklist_remove_role import blacklist_remove_role as command_fn
