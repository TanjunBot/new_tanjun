"""Integration tests for commands.logs.blacklist_channel.blacklist_remove_channel.blacklist_remove_channel."""
...
PROFILE = CommandProfile.from_module('commands.logs.blacklist_channel.blacklist_remove_channel', 'blacklist_remove_channel', 'info, channel=info.channel')


async def test_blacklist_remove_channel_restricted(restricted_command_info):
...
async def test_blacklist_remove_channel_no_guild(no_guild_command_info):
...
async def test_blacklist_remove_channel_admin(admin_command_info):
