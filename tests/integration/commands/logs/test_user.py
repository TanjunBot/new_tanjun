"""Integration tests for commands.logs.blacklist_user.blacklist_user."""
...
from commands.logs.blacklist_user.blacklist_user import blacklist_user as command_fn
...
@pytest.mark.asyncio
@patch("commands.logs.blacklist_user.blacklist_user.is_log_entity_blacklisted", new_callable=AsyncMock)
@patch("commands.logs.blacklist_user.blacklist_user.add_log_blacklist", new_callable=AsyncMock)
