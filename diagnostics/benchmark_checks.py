...
_LOCALE_SAMPLE_KEYS = ('commands.admin.ban.error.description', 'commands.admin.administration.test_bot.starting', 'commands.admin.administration.update.updating', 'commands.fun.boop.title', 'commands.fun.hug.title', 'commands.games.akinator.back', 'commands.games.akinator.description', 'commands.channel.dynamicslowmode.success.title', 'commands.channel.dynamicslowmode.notSet.title', 'commands.admin.administration.situation_not_found')
