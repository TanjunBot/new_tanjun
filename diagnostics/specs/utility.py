...
from diagnostics.specs._helpers import default_channel_kwargs, register_kwargs
...
def register() -> None:
    ...
    register_kwargs("utility.BoosterRoleCommands.setboosterrole", default_channel_kwargs)
