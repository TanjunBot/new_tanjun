...
class ImageCommands(discord.app_commands.Group):  # type: ignore[misc,no-any-unimported]
    ...
    async def blurimage(  # type: ignore[misc,no-any-unimported]
        self,
        ...
        await blur_image(commandInfo=commandInfo, image=image, type=type, radius=radius)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_contour_name"),
        description=app_commands.locale_str("image_contour_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_contour_params_image_description"))  # type: ignore[untyped-decorator]
    async def contourimage(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await contour_image(commandInfo=commandInfo, image=image)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_detail_name"),
        description=app_commands.locale_str("image_detail_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_detail_params_image_description"))  # type: ignore[untyped-decorator]
    async def detailimage(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await detail_image(commandInfo=commandInfo, image=image)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_edgeenhance_name"),
        description=app_commands.locale_str("image_edgeenhance_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_edgeenhance_params_image_description"))  # type: ignore[untyped-decorator]
    async def edgeenhance(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await edge_enhance(commandInfo=commandInfo, image=image)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_emboss_name"),
        description=app_commands.locale_str("image_emboss_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_emboss_params_image_description"))  # type: ignore[untyped-decorator]
    async def emboss(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await emboss(commandInfo=commandInfo, image=image)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_findedges_name"),
        description=app_commands.locale_str("image_findedges_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_findedges_params_image_description"))  # type: ignore[untyped-decorator]
    async def findedges(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await find_edges(commandInfo=commandInfo, image=image)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_sharpen_name"),
        description=app_commands.locale_str("image_sharpen_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_sharpen_params_image_description"))  # type: ignore[untyped-decorator]
    async def sharpen(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await sharpen(commandInfo=commandInfo, image=image)

    @app_commands.command(  # type: ignore[untyped-decorator]
        name=app_commands.locale_str("image_smooth_name"),
        description=app_commands.locale_str("image_smooth_description"),
    )
    @app_commands.describe(image=app_commands.locale_str("image_smooth_params_image_description"))  # type: ignore[untyped-decorator]
    async def smooth(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
        ...
        await smooth(commandInfo=commandInfo, image=image)
    ...
    async def resize(  # type: ignore[misc,no-any-unimported]
        self,
        interaction: discord.Interaction,
        image: discord.Attachment,
        ...
        await resize(commandInfo=commandInfo, image=image, width=width, height=height)
    ...
    async def rescale(  # type: ignore[misc,no-any-unimported]
        self,
        interaction: discord.Interaction,
        image: discord.Attachment,
        ...
        await rescale(commandInfo=commandInfo, image=image, factor=factor)
    ...
    async def mirror(  # type: ignore[misc,no-any-unimported]
        self,
        interaction: discord.Interaction,
        image: discord.Attachment,
        direction: str = "x",
        ...
        await mirror(commandInfo=commandInfo, image=image, axis=direction)
    ...
    async def compress(  # type: ignore[misc,no-any-unimported]
        self,
        interaction: discord.Interaction,
        image: discord.Attachment,
        ...
        await compress(commandInfo=commandInfo, image=image, quality=quality)
    ...
    async def background(self, interaction: discord.Interaction, image: discord.Attachment) -> None:  # type: ignore[misc,no-any-unimported]
        await interaction.response.defer()
        commandInfo = utility.CommandInfo(
            user=interaction.user,
            channel=cast(discord.abc.GuildChannel, interaction.channel),  # type: ignore[no-any-unimported]
...
class ImageCog(commands.Cog):  # type: ignore[misc,no-any-unimported]
