...
class MathCommands(discord.app_commands.Group):
    ...
    @app_commands.command(name=locale.math.calc.name.discord_key, description=locale.math.calc.description.discord_key)
    @app_commands.describe(expression=locale.math.calc.params.expression.description.discord_key)
    ...
    @app_commands.command(name=locale.math.calculator.name.discord_key, description=locale.math.calculator.description.discord_key)
    @app_commands.describe(equation=locale.math.calculator.params.equation.description.discord_key)
    ...
    @app_commands.command(name=locale.math.num2word.name.discord_key, description=locale.math.num2word.description.discord_key)
    @app_commands.describe(number=locale.math.num2word.params.number.description.discord_key, locale=locale.math.num2word.params.locale.description.discord_key)
    ...
    @app_commands.command(name=locale.math.randomnumber.name.discord_key, description=locale.math.randomnumber.description.discord_key)
    @app_commands.describe(min=locale.math.randomnumber.params.min.description.discord_key, max=locale.math.randomnumber.params.max.description.discord_key, amount=locale.math.randomnumber.params.amount.description.discord_key)
    ...
    @app_commands.command(name=locale.math.plotfunction.name.discord_key, description=locale.math.plotfunction.description.discord_key)
    @app_commands.describe(func=locale.math.plotfunction.params.func.description.discord_key, xmin=locale.math.plotfunction.params.xmin.description.discord_key, xmax=locale.math.plotfunction.params.xmax.description.discord_key)
    ...
    @app_commands.command(name=locale.math.faculty.name.discord_key, description=locale.math.faculty.description.discord_key)
    @app_commands.describe(number=locale.math.faculty.params.number.description.discord_key)
...
class MathCog(commands.Cog):
    ...
    async def on_ready(self) -> None:
        mathcmds = MathCommands(name=locale.math.name.discord_key, description=locale.math.description.discord_key)
        if self.bot.tree:
