...
class GameCommands(discord.app_commands.Group):
    ...
    @app_commands.choices(size=[app_commands.Choice(value='7,6', name=locale.games.connect4.params.size.default.discord_key), app_commands.Choice(value='8,7', name=locale.games.connect4.params.size['8x7'].discord_key), app_commands.Choice(value='9,8', name=locale.games.connect4.params.size['9x8'].discord_key), app_commands.Choice(value='10,9', name=locale.games.connect4.params.size['10x9'].discord_key), app_commands.Choice(value='11,10', name=locale.games.connect4.params.size['11x10'].discord_key), app_commands.Choice(value='12,11', name=locale.games.connect4.params.size['12x11'].discord_key), app_commands.Choice(value='12,12', name=locale.games.connect4.params.size['12x12'].discord_key), app_commands.Choice(value='4,4', name=locale.games.connect4.params.size['4x4'].discord_key)])
    ...
    @app_commands.command(name=locale.hangman.name.discord_key, description=locale.hangman.description.discord_key)
