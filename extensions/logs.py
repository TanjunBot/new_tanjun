...
class LogsCog(commands.Cog):
    ...
    async def on_automod_rule_create(self, rule: discord.AutoModRule) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, rule.guild.id, str(rule.channel_id)):
            return
    ...
    async def on_automod_action(self, execution: discord.AutoModAction) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, execution.guild.id, str(execution.channel.id)):  # type: ignore[union-attr]
            return
    ...
    async def on_guild_channel_delete(self, channel: discord.abc.GuildChannel) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, channel.guild.id, str(channel.id)):
            return
    ...
    async def on_guild_channel_update(self, before: discord.abc.GuildChannel, after: discord.abc.GuildChannel) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, after.guild.id, str(after.id)):
            return
    ...
    async def on_invite_create(self, invite: discord.Invite) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, invite.guild.id, str(invite.inviter.id)):  # type: ignore[union-attr]
            return
    ...
    async def on_member_join(self, member: discord.Member) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, member.guild.id, str(member.id)):
            return
    ...
    async def on_member_update(self, before: discord.Member, after: discord.Member) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, after.guild.id, str(after.id)):
            return
    ...
    async def on_user_update(self, before: discord.User, after: discord.User) -> None:
        for guild in self.bot.guilds:
            ...
            if await is_log_blacklisted(LogBlacklistTarget.USER, guild.id, str(before.id)):
                continue
    ...
    async def on_member_ban(self, user: discord.Member) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, user.guild.id, str(user.id)):
            return
    ...
    async def on_member_unban(self, guild: discord.Guild, user: discord.User) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, guild.id, str(user.id)):
            return
    ...
    async def on_message_edit(self, before: discord.Message, after: discord.Message) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, after.guild.id, str(after.author.id)):  # type: ignore[union-attr]
            return

        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, after.guild.id, str(after.channel.id)):  # type: ignore[union-attr]
            return
    ...
    async def on_message_delete(self, message: discord.Message) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, message.guild.id, str(message.author.id)):  # type: ignore[union-attr]
            return

        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, message.guild.id, str(message.channel.id)):  # type: ignore[union-attr]
            return
    ...
    async def on_reaction_add(self, reaction: discord.Reaction, user: discord.User) -> None:
        ...
        if await is_log_blacklisted(LogBlacklistTarget.USER, reaction.guild.id, str(user.id)):
            return

        if await is_log_blacklisted(LogBlacklistTarget.CHANNEL, reaction.guild.id, str(reaction.message.channel.id)):
            return
