...
class WarnCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.warn.add.name.discord_key, description=locale.admin.warn.add.description.discord_key
    )
    @app_commands.describe(
        user=locale.admin.warn.add.params.member.description.discord_key,
        reason=locale.admin.warn.add.params.reason.description.discord_key,
    )
    async def add(
    ...
    @app_commands.command(
        name=locale.admin.warn.view.name.discord_key, description=locale.admin.warn.view.description.discord_key
    )
    ...
    @app_commands.command(
        name=locale.admin.warn.config.name.discord_key, description=locale.admin.warn.config.description.discord_key
    )
...
class RoleCommands(discord.app_commands.Group):
    ...
    @app_commands.describe(
        user=locale.admin.addrole.params.user.name.discord_key, role=locale.admin.addrole.params.role.name.discord_key
    )
    ...
    @app_commands.command(
        name=locale.admin.removerole.name.discord_key, description=locale.admin.removerole.description.discord_key
    )
    @app_commands.describe(
        user=locale.admin.removerole.params.user.description.discord_key,
        role=locale.admin.removerole.params.role.description.discord_key,
    )
...
class RoleManageCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.createrole.name.discord_key, description=locale.admin.createrole.description.discord_key
    )
    @app_commands.describe(
        name=locale.admin.createrole.params.name.description.discord_key,
        color=locale.admin.createrole.params.color.description.discord_key,
        display_icon=locale.admin.createrole.params.displayicon.description.discord_key,
        hoist=locale.admin.createrole.params.hoist.description.discord_key,
        mentionable=locale.admin.createrole.params.mentionable.description.discord_key,
        reason=locale.admin.createrole.params.reason.description.discord_key,
        display_emoji=locale.admin.createrole.params.displayemoji.description.discord_key,
    )
    ...
    @app_commands.command(
        name=locale.admin.deleterole.name.discord_key, description=locale.admin.deleterole.description.discord_key
    )
    @app_commands.describe(
        role=locale.admin.deleterole.params.role.description.discord_key,
        reason=locale.admin.deleterole.params.reason.description.discord_key,
    )
    ...
    @app_commands.command(
        name=locale.admin.moverole.name.discord_key, description=locale.admin.moverole.description.discord_key
    )
    @app_commands.describe(
        role=locale.admin.moverole.params.role.description.discord_key,
        target_role=locale.admin.moverole.params.targetrole.description.discord_key,
        position=locale.admin.moverole.params.position.description.discord_key,
    )
    @app_commands.choices(
        position=[
            app_commands.Choice(name=locale.admin.moverole.params.position.above.name.discord_key, value="above"),
            app_commands.Choice(name=locale.admin.moverole.params.position.below.name.discord_key, value="below"),
        ]
    )
    async def moverole(
        self,
    ...
    @app_commands.command(
        name=locale.admin.copyrole.name.discord_key, description=locale.admin.copyrole.description.discord_key
    )
    @app_commands.describe(
        role=locale.admin.copyrole.params.role.description.discord_key,
        copymembers=locale.admin.copyrole.params.copymembers.description.discord_key,
    )
    @app_commands.choices(
        copymembers=[
            app_commands.Choice(name=locale.admin.copyrole.params.copymembers.true.discord_key, value="true"),
            app_commands.Choice(name=locale.admin.copyrole.params.copymembers.false.discord_key, value="false"),
        ]
    )
    async def copyrole(
...
class ReportCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.rps.setchannel.name.discord_key, description=locale.admin.rps.setchannel.description.discord_key
    )
    ...
    @app_commands.command(
        name=locale.admin.rps.removechannel.name.discord_key,
        description=locale.admin.rps.removechannel.description.discord_key,
    )
    ...
    @app_commands.command(
        name=locale.admin.rps.showreports.name.discord_key, description=locale.admin.rps.showreports.description.discord_key
    )
    ...
    @app_commands.command(
        name=locale.admin.rps.unblockreporter.name.discord_key,
        description=locale.admin.rps.unblockreporter.description.discord_key,
    )
...
class TriggerMessagesCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.tm.configure.name.discord_key, description=locale.admin.tm.configure.description.discord_key
    )
    ...
    @app_commands.describe(
        trigger=locale.admin.tm.add.params.trigger.description.discord_key,
        response=locale.admin.tm.add.params.response.description.discord_key,
        casesensitive=locale.admin.tm.add.params.casesensitive.description.discord_key,
    )
    @app_commands.choices(
        casesensitive=[
            app_commands.Choice(name=locale.admin.tm.add.params.casesensitive.true.discord_key, value="t"),
            app_commands.Choice(name=locale.admin.tm.add.params.casesensitive.false.discord_key, value="f"),
        ]
    )
    async def add(
        self,
        ...
        await addTriggerMessageCommand(
            ...
            trigger=trigger,
            response=response,
            case_sensitive=casesensitive.value == "t" if casesensitive else False,
        )
        return
...
class JoinToCreateCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.jtc.setchannel.name.discord_key, description=locale.admin.jtc.setchannel.description.discord_key
    )
    ...
    @app_commands.command(
        name=locale.admin.jtc.removechannel.name.discord_key,
        description=locale.admin.jtc.removechannel.description.discord_key,
    )
...
class AdminModerationCommands(discord.app_commands.Group):
    ...
    @app_commands.describe(
        user=locale.admin.kick.params.user.description.discord_key,
        reason=locale.admin.kick.params.reason.description.discord_key,
    )
    async def kick(
        self, interaction: discord.Interaction, user: discord.Member, reason: app_commands.Range[str, 0, 100] = None
    ) -> None:
    ...
    @app_commands.describe(
        user=locale.admin.ban.params.user.description.discord_key,
        reason=locale.admin.ban.params.reason.description.discord_key,
        delete_message_days=locale.admin.ban.params.deletemessagedays.description.discord_key,
    )
    async def ban(
        self,
        interaction: discord.Interaction,
    ...
    @app_commands.describe(
        username=locale.admin.unban.params.username.description.discord_key,
        reason=locale.admin.unban.params.reason.description.discord_key,
    )
    async def unban(
        self,
        interaction: discord.Interaction,
    ...
    @app_commands.describe(
        user=locale.admin.timeout.params.member.description.discord_key,
        duration=locale.admin.timeout.params.duration.description.discord_key,
        reason=locale.admin.timeout.params.reason.description.discord_key,
    )
    async def timeout(
        self,
        interaction: discord.Interaction,
    ...
    @app_commands.command(
        name=locale.admin.removetimeout.name.discord_key, description=locale.admin.removetimeout.description.discord_key
    )
    @app_commands.describe(
        user=locale.admin.removetimeout.params.member.description.discord_key,
        reason=locale.admin.removetimeout.params.reason.description.discord_key,
    )
    ...
    @app_commands.command(
        name=locale.admin.nickname.name.discord_key, description=locale.admin.nickname.description.discord_key
    )
    @app_commands.describe(
        user=locale.admin.nickname.params.member.description.discord_key,
        nickname=locale.admin.nickname.params.nickname.description.discord_key,
    )
    async def nickname(
        self, interaction: discord.Interaction, user: discord.Member, nickname: app_commands.Range[str, 0, 100] = None
    ) -> None:
        await interaction.response.defer()
        command_info = utility.CommandInfo(
            user=interaction.user,
...
class AdminPurgeCommands(discord.app_commands.Group):
    ...
    @app_commands.describe(
        limit=locale.admin.purge.params.amount.description.discord_key,
        channel=locale.admin.purge.params.channel.description.discord_key,
        setting=locale.admin.purge.params.setting.description.discord_key,
    )
    @app_commands.choices(
        setting=[
            app_commands.Choice(value="all", name=locale.admin.purge.params.setting.all.discord_key),
            app_commands.Choice(value="bot", name=locale.admin.purge.params.setting.bot.discord_key),
            app_commands.Choice(value="user", name=locale.admin.purge.params.setting.user.discord_key),
            app_commands.Choice(value="notPinned", name=locale.admin.purge.params.setting.notPinned.discord_key),
            app_commands.Choice(value="userNotPinned", name=locale.admin.purge.params.setting.userNotPinned.discord_key),
            app_commands.Choice(value="botNotPinned", name=locale.admin.purge.params.setting.botNotPinned.discord_key),
            app_commands.Choice(value="notadmin", name=locale.admin.purge.params.setting.notAdmin.discord_key),
            app_commands.Choice(value="notUserAdmin", name=locale.admin.purge.params.setting.notUserAdmin.discord_key),
            app_commands.Choice(value="embeds", name=locale.admin.purge.params.setting.embeds.discord_key),
            app_commands.Choice(value="files", name=locale.admin.purge.params.setting.files.discord_key),
            app_commands.Choice(
                value="notAdminNotPinned", name=locale.admin.purge.params.setting.notAdminNotPinned.discord_key
            ),
        ]
    )
    async def purge(
        ...
        await purgeCommand(
            command_info=command_info, amount=limit, channel=channel, setting=setting.value if setting != "all" else "all"
        )
        return
...
class AdminChannelCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.slowmode.name.discord_key, description=locale.admin.slowmode.description.discord_key
    )
    @app_commands.describe(
        seconds=locale.admin.slowmode.params.seconds.description.discord_key,
        channel=locale.admin.slowmode.params.channel.description.discord_key,
    )
    async def slowmode(
        self, interaction: discord.Interaction, seconds: app_commands.Range[int, 1, 21600], channel: discord.TextChannel = None
    ) -> None:
        await interaction.response.defer()
        command_info = utility.CommandInfo(
            user=interaction.user,
...
class AdminMessagingCommands(discord.app_commands.Group):
    ...
    @app_commands.describe(
        channel=locale.admin.say.params.channel.description.discord_key,
        message=locale.admin.say.params.message.description.discord_key,
    )
    async def say(
        self, interaction: discord.Interaction, message: app_commands.Range[str, 1, 2000], channel: discord.TextChannel = None
    ) -> None:
        await interaction.response.defer(ephemeral=True)
        command_info = utility.CommandInfo(
            user=interaction.user,
    ...
    @app_commands.describe(
        title=locale.admin.embed.params.title.description.discord_key,
        channel=locale.admin.embed.params.channel.description.discord_key,
    )
    async def embed(
        self, interaction: discord.Interaction, title: app_commands.Range[str, 1, 256], channel: discord.TextChannel = None
    ) -> None:
        await interaction.response.defer(ephemeral=True)
        command_info = utility.CommandInfo(
            user=interaction.user,
...
class AdminEmojiCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.createemoji.name.discord_key, description=locale.admin.createemoji.description.discord_key
    )
    @app_commands.describe(
        name=locale.admin.createemoji.params.name.description.discord_key,
        imageurl=locale.admin.createemoji.params.imageUrl.description.discord_key,
    )
    async def createemoji(self, interaction: discord.Interaction, name: str, imageurl: str) -> None:
        ...
        role_select = discord.ui.RoleSelect(
            placeholder=locale.commands.admin.createEmoji.role_selectPlaceholder(interaction.locale),
    ...
    @app_commands.command(
        name=locale.admin.copyemoji.name.discord_key, description=locale.admin.copyemoji.description.discord_key
    )
    ...
    @app_commands.command(
        name=locale.admin.boosterrole.name.discord_key, description=locale.admin.boosterrole.description.discord_key
    )
...
class AdminSetupCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.createticket.name.discord_key, description=locale.admin.createticket.description.discord_key
    )
    @app_commands.describe(
        name=locale.admin.createticket.params.name.description.discord_key,
        description=locale.admin.createticket.params.description.description.discord_key,
        channel=locale.admin.createticket.params.channel.description.discord_key,
        pingrole=locale.admin.createticket.params.pingrole.description.discord_key,
        summarychannel=locale.admin.createticket.params.summarychannel.description.discord_key,
        introduction=locale.admin.createticket.params.introduction.description.discord_key,
    )
...
class AdminLocaleCommands(discord.app_commands.Group):
    @app_commands.command(
        name=locale.admin.setlocale.name.discord_key, description=locale.admin.setlocale.description.discord_key
    )
    @app_commands.describe(locale=locale.admin.setlocale.params.locale.description.discord_key)
    @app_commands.choices(
        locale=[
            app_commands.Choice(value="bg", name=locale.games.hangman.params.language.bg.discord_key),
            app_commands.Choice(value="cs", name=locale.games.hangman.params.language.cs.discord_key),
            app_commands.Choice(value="da", name=locale.games.hangman.params.language.da.discord_key),
            app_commands.Choice(value="de", name=locale.games.hangman.params.language.de.discord_key),
            app_commands.Choice(value="el", name=locale.games.hangman.params.language.el.discord_key),
            app_commands.Choice(value="en", name=locale.games.hangman.params.language.en.discord_key),
            app_commands.Choice(value="es", name=locale.games.hangman.params.language.es.discord_key),
            app_commands.Choice(value="fi", name=locale.games.hangman.params.language.fi.discord_key),
            app_commands.Choice(value="fr", name=locale.games.hangman.params.language.fr.discord_key),
            app_commands.Choice(value="hi", name=locale.games.hangman.params.language.hi.discord_key),
            app_commands.Choice(value="hu", name=locale.games.hangman.params.language.hu.discord_key),
            app_commands.Choice(value="id", name=locale.games.hangman.params.language.id.discord_key),
            app_commands.Choice(value="it", name=locale.games.hangman.params.language.it.discord_key),
            app_commands.Choice(value="ja", name=locale.games.hangman.params.language.ja.discord_key),
            app_commands.Choice(value="ko", name=locale.games.hangman.params.language.ko.discord_key),
            app_commands.Choice(value="lt", name=locale.games.hangman.params.language.lt.discord_key),
            app_commands.Choice(value="nb", name=locale.games.hangman.params.language.nb.discord_key),
            app_commands.Choice(value="nl", name=locale.games.hangman.params.language.nl.discord_key),
            app_commands.Choice(value="pl", name=locale.games.hangman.params.language.pl.discord_key),
            app_commands.Choice(value="pt", name=locale.games.hangman.params.language.pt.discord_key),
            app_commands.Choice(value="ru", name=locale.games.hangman.params.language.ru.discord_key),
            app_commands.Choice(value="zh", name=locale.games.hangman.params.language.zh.discord_key),
        ]
    )
...
class AdminCog(commands.Cog):
    ...
    async def on_ready(self) -> None:
        top_level_groups = [
            WarnCommands(name=locale.admin.warn.name.discord_key, description=locale.admin.warn.description.discord_key),
            RoleCommands(name=locale.admin.role.name.discord_key, description=locale.admin.role.description.discord_key),
            RoleManageCommands(
                name=locale.admin.rolemanage.name.discord_key, description=locale.admin.rolemanage.description.discord_key
            ),
            ReportCommands(name=locale.admin.report.name.discord_key, description=locale.admin.report.description.discord_key),
            TriggerMessagesCommands(
                name=locale.admin.triggermessages.name.discord_key,
                description=locale.admin.triggermessages.description.discord_key,
            ),
            JoinToCreateCommands(
                name=locale.admin.jointocreate.name.discord_key, description=locale.admin.jointocreate.description.discord_key
            ),
            AdminModerationCommands(
                name=locale.admin.moderation.name.discord_key, description=locale.admin.moderation.description.discord_key
            ),
            AdminPurgeCommands(
                name=locale.admin.purgegroup.name.discord_key, description=locale.admin.purgegroup.description.discord_key
            ),
            AdminChannelCommands(
                name=locale.admin.channels.name.discord_key, description=locale.admin.channels.description.discord_key
            ),
            AdminMessagingCommands(
                name=locale.admin.messaging.name.discord_key, description=locale.admin.messaging.description.discord_key
            ),
            AdminEmojiCommands(
                name=locale.admin.emoji.name.discord_key, description=locale.admin.emoji.description.discord_key
            ),
            AdminSetupCommands(
                name=locale.admin.setup.name.discord_key, description=locale.admin.setup.description.discord_key
            ),
            AdminLocaleCommands(
                name=locale.admin.localegroup.name.discord_key, description=locale.admin.localegroup.description.discord_key
            ),
        ]
