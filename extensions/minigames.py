...
class CountingCommands(discord.app_commands.Group):
    ...
    @app_commands.describe(
        channel=app_commands.locale_str("games_setcountingch_params_channel_description"),
    )
...
class minigameCog(commands.Cog):
    ...
    async def on_ready(self):
        minigameCmds = minigameCommands(name="minigame", description="Minigame Commands")
        countingCmds = CountingCommands(name=app_commands.locale_str("utility_countingcmds_name"), description=app_commands.locale_str("utility_countingcmds_description"))
