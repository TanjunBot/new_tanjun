...
class funCommands(discord.app_commands.Group):
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_hug_params_member_description"),
        message=app_commands.locale_str("fun_hug_params_message_description"),
    )
    async def hug(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'hug'
        ...
        await fun_command(commandInfo, fun_type, member, message)
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_kiss_params_member_description"),
        message=app_commands.locale_str("fun_kiss_params_message_description"),
    )
    async def kiss(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'kiss'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_boop_params_member_description"),
        message=app_commands.locale_str("fun_boop_params_message_description"),
    )
    async def boop(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'boop'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_wave_params_member_description"),
        message=app_commands.locale_str("fun_wave_params_message_description"),
    )
    async def wave(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'wave'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_slap_params_member_description"),
        message=app_commands.locale_str("fun_slap_params_message_description"),
    )
    async def slap(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'slap'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_laugh_params_member_description"),
        message=app_commands.locale_str("fun_laugh_params_message_description"),
    )
    async def laugh(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'laugh'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_tickle_params_member_description"),
        message=app_commands.locale_str("fun_tickle_params_message_description"),
    )
    async def tickle(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'tickle'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_pat_params_member_description"),
        message=app_commands.locale_str("fun_pat_params_message_description"),
    )
    async def pat(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'pat'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
    ...
    @app_commands.describe(
        member=app_commands.locale_str("fun_poke_params_member_description"),
        message=app_commands.locale_str("fun_poke_params_message_description"),
    )
    async def poke(self, ctx, member: discord.Member, message: app_commands.Range[str, 0, 2000] = None):
        fun_type = 'poke'
        await ctx.response.defer()
        commandInfo = utility.commandInfo(
            user=ctx.user,
