...
async def detail_image(commandInfo: utility.commandInfo, image: discord.Attachment):
    ...
    buffer.seek(0)
    embed = utility.tanjunEmbed(
        title=tanjunLocalizer.localize(commandInfo.locale, "commands.image.detail.success.title"),
        description=tanjunLocalizer.localize(commandInfo.locale, "commands.image.detail.success.description"),
    )
