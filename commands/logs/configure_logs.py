...
async def configure_logs(command_info: utility.command_info):
    if not command_info.user.guild_permissions.administrator:
        embed = utility.tanjunEmbed(
            title=l10n.commands.logs.setLogChannel.missingPermission.title(command_info.locale),
            description=l10n.commands.logs.setLogChannel.missingPermission.description(command_info.locale),
        )
    ...
    class LogConfigureView(discord.ui.View):
        ...
        @discord.ui.button(
            label=l10n.commands.logs.configureLogs.configuration_embed.activate(command_info.locale),
        ...
        @discord.ui.button(
            label=l10n.commands.logs.configureLogs.configuration_embed.deactivate(command_info.locale),
    ...
    embed = utility.tanjunEmbed(
        title=l10n.commands.logs.configureLogs.title(command_info.locale), description=configuration_embed
    )
