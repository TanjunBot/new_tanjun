...
async def list_scheduled_messages(commandInfo: utility.commandInfo):
        ...
        def get_embed(self):
            ...
            for msg in page_messages:
                ...
                field_value = tanjunLocalizer.localize(
                    ...
                    channel="<#" + str(msg[2]) + ">" if msg[2] else tanjunLocalizer.localize(
                        self.locale,
                        "commands.utility.listscheduled.direct_message"
                    ),
                    repeat=msg[6] or tanjunLocalizer.localize(
                        self.locale,
    ...
    view.message = await commandInfo.reply(embed=view.get_embed(), view=view if len(messages) > MESSAGES_PER_PAGE else discord.ui.View())