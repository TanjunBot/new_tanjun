...
async def brawlers(commandInfo: commandInfo, playerTag: str):
    ...
    for brawler in playerInfo["brawlers"]:
        ...
        description = tanjunLocalizer.localize(
            commandInfo.locale,
            "commands.utility.brawlstars.brawlers.description.overwiev",
            name=name,
            power=power,
            rank=rank,
            trophies=trophies,
    ...
    class SearchModal(discord.ui.Modal):
        def __init__(self, commandInfo: commandInfo):
            super().__init__(title=tanjunLocalizer.localize(commandInfo.locale, "commands.utility.brawlstars.brawlers.search.title"))
            self.commandInfo = commandInfo
            self.add_item(
                discord.ui.TextInput(
                    label=tanjunLocalizer.localize(commandInfo.locale, "commands.utility.brawlstars.brawlers.search.label"),
                    placeholder=tanjunLocalizer.localize(commandInfo.locale, "commands.utility.brawlstars.brawlers.search.placeholder"),
                    required=True,
                )
            )
        ...
        async def on_submit(self, interaction: discord.Interaction):
            try:
                ...
                embed = tanjunEmbed(
                    title=tanjunLocalizer.localize(self.commandInfo.locale, "commands.utility.brawlstars.brawlers.search.error.title"),
                    description=tanjunLocalizer.localize(self.commandInfo.locale, "commands.utility.brawlstars.brawlers.search.error.invalidInput"),
                )
