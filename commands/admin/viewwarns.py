...
class WarningView(View):
    ...
    def update_buttons(self):
        ...
        if self.page > 0:
            prev_button = Button(label=tanjunLocalizer.localize(self.commandInfo.locale, "commands.admin.viewwarns.prevButton"), style=discord.ButtonStyle.primary)
        ...
        if (self.page + 1) * WARNINGS_PER_PAGE < len(self.warnings):
            next_button = Button(label=tanjunLocalizer.localize(self.commandInfo.locale, "commands.admin.viewwarns.nextButton"), style=discord.ButtonStyle.primary)
        ...
        if not self.warnings:
            embed = utility.tanjunEmbed(
                ...
                description=tanjunLocalizer.localize(
                    self.commandInfo.locale, "commands.admin.viewwarns.noWarnings.description",
...
def create_warnings_embed(commandInfo, member, warnings, page):
    ...
    embed = utility.tanjunEmbed(
        title=tanjunLocalizer.localize(
            commandInfo.locale, "commands.admin.viewwarns.title",
            user=member.name
        ),
        description=tanjunLocalizer.localize(
