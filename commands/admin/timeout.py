...
async def timeout(
    ...
    if member.top_role >= commandInfo.user.top_role:
        embed = utility.tanjunEmbed(
            ...
            description=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.timeout.targetTooHigh.description"
            ),
        )
        await commandInfo.reply(embed=embed)
        return
    ...
    try:
            ...
            description=tanjunLocalizer.localize(
                ...
                reason=(
                    ...
                    if reason
                        ...
                        commandInfo.locale, "commands.admin.timeout.noReasonProvided"
                    )
                ),
            ),
        )
        ...
        embed = utility.tanjunEmbed(
            ...
            description=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.timeout.forbidden.description"
            ),
        )
        await commandInfo.reply(embed=embed)
        ...
        embed = utility.tanjunEmbed(
            ...
            description=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.timeout.error.description"
            ),
        )
        await commandInfo.reply(embed=embed)
    except TypeError:
        embed = utility.tanjunEmbed(
            ...
            description=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.timeout.invalidDuration.description"
            ),
        )
        await commandInfo.reply(embed=embed)
