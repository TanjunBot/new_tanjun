...
async def change_nickname(commandInfo: utility.commandInfo, member: discord.Member, nickname: str = None):
    if not commandInfo.user.guild_permissions.manage_nicknames:
        embed = utility.tanjunEmbed(
            title=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.nickname.missingPermission.title"
            ),
    ...
    if not commandInfo.guild.me.guild_permissions.manage_nicknames:
        embed = utility.tanjunEmbed(
            title=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.nickname.missingPermissionBot.title"
            ),
            description=tanjunLocalizer.localize(
                commandInfo.locale,
    ...
    try:
        ...
        if nickname:
            embed = utility.tanjunEmbed(
                title=tanjunLocalizer.localize(
                    commandInfo.locale, "commands.admin.nickname.changed.title"
                ),
                description=tanjunLocalizer.localize(
                    commandInfo.locale,
            ...
            embed = utility.tanjunEmbed(
                title=tanjunLocalizer.localize(
                    commandInfo.locale, "commands.admin.nickname.removed.title"
                ),
                description=tanjunLocalizer.localize(
                    commandInfo.locale,
