...
class EmbedCreatorView(View):
    ...
    @discord.ui.button(label="commands.admin.embed.buttons.setDescription", style=discord.ButtonStyle.primary)
    async def set_description(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_modal(DescriptionModal(self))

    @discord.ui.button(label="commands.admin.embed.buttons.addField", style=discord.ButtonStyle.primary)
    async def add_field(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_modal(FieldModal(self))

    @discord.ui.button(label="commands.admin.embed.buttons.setFooter", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(label="commands.admin.embed.buttons.setColor", style=discord.ButtonStyle.primary)
    async def set_color(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_modal(ColorModal(self))

    @discord.ui.button(label="commands.admin.embed.buttons.preview", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="commands.admin.embed.buttons.send", style=discord.ButtonStyle.green)
    ...
    if not commandInfo.user.guild_permissions.manage_messages:
        embed = utility.tanjunEmbed(
            title=tanjunLocalizer.localize(
                commandInfo.locale, "commands.admin.embed.missingPermission.title"
            ),
