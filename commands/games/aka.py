...
class Akinator():
    ...
    def start_game(self):
        ...
        game = requests.post(f"{self.ENDPOINT}game", json={"sid": self.json["sid"], "cm": self.json["cm"]})
        game.encoding = 'utf-8'  # Ensure correct character encoding is applied
        game_text = game.text
        soup = BeautifulSoup(game_text, "html.parser")
    ...
    def post_answer(self, answer: str):
        ...
        try:
            ...
            progression.encoding = 'utf-8'  # Ensure correct character encoding is applied
    ...
    def go_back(self):
        ...
        try:
            ...
            goback.encoding = 'utf-8'  # Ensure correct character encoding is applied
            goback = goback.json()
    ...
    def exclude(self):
        ...
        try:
            ...
            exclude.encoding = 'utf-8'  # Ensure correct character encoding is applied
