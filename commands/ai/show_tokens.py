...
async def show_tokens(command_info: utility.CommandInfo) -> None:
    ...
    embed = utility.tanjunEmbed(title=locale.commands.ai.tokens.success.title(str(command_info.locale)), description=locale.commands.ai.tokens.success.description(command_info.locale, total=total, free=overview.free_token, plus=overview.plus_token, paid=overview.paid_token, used=overview.used_token))
