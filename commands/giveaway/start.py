...
class GiveawayBuilderButton(ui.Button):  # type: ignore[type-arg]
    ...
    async def callback(self, interaction: discord.Interaction) -> None:
        await self.view.button_callback(interaction, self)  # type: ignore[union-attr]
...
class CustomNameModal(ui.Modal):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        if interaction.user != self.commandInfo.user:  # type: ignore[misc]
            await interaction.response.send_message(
                tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.not_authorized"),  # type: ignore[misc]
                ephemeral=True,
            )
            return False
        return True
    ...
    async def on_timeout(self) -> None:
        self.view.last_action = tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.modal.timeout")  # type: ignore[misc]
...
class SponsorView(ui.View):
    def __init__(self, commandInfo, view) -> None:  # type: ignore[no-untyped-def]
        ...
        userSelect = discord.ui.UserSelect(  # type: ignore[var-annotated]
            placeholder=tanjunLocalizer.localize(
                self.commandInfo.locale,  # type: ignore[misc]
        ...
        userSelect.callback = self.on_user_select  # type: ignore[method-assign]
        self.add_item(userSelect)

        confirmBtn = discord.ui.Button(  # type: ignore[var-annotated]
            label=tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.confirm"),  # type: ignore[misc]
            style=discord.ButtonStyle.green,
            custom_id="confirm",
        )
        confirmBtn.callback = self.on_button_press  # type: ignore[method-assign]
        self.add_item(confirmBtn)
        cancelBtn = discord.ui.Button(  # type: ignore[var-annotated]
            label=tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.cancel"),  # type: ignore[misc]
            style=discord.ButtonStyle.red,
            custom_id="cancel",
        )
        cancelBtn.callback = self.on_button_press  # type: ignore[method-assign]
    ...
    async def on_user_select(self, interaction: discord.Interaction) -> None:
        self.selected_user = interaction.data["values"][0]  # type: ignore[index, assignment, typeddict-item]
...
class ChangeWinnersModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        winners = int(self.children[0].value)  # type: ignore[attr-defined]
        self.view.giveaway_data["winners"] = winners
        self.view.last_action = tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.winner.updated")  # type: ignore[misc]
        await self.view.update_embed(interaction.response.edit_message)
...
class EndTimeModal(ui.Modal):
    def __init__(self, view, commandInfo, title, description) -> None:  # type: ignore[no-untyped-def]
        ...
        self.add_item(
            ui.TextInput(
                label=tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.end_time.label"),  # type: ignore[misc]
                placeholder=tanjunLocalizer.localize(
                    self.commandInfo.locale,  # type: ignore[misc]
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        end_time = self.children[0].value  # type: ignore[attr-defined]
        self.view.giveaway_data["end_time"] = end_time
        self.view.last_action = tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.end_time.updated")  # type: ignore[misc]
        await self.view.update_embed(interaction.response.edit_message)
...
class MessageRequirementModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        new_message_requirement = int(self.children[0].value)  # type: ignore[attr-defined]
...
class RoleRequirementView(ui.View):
    def __init__(self, view, commandInfo, title, description) -> None:  # type: ignore[no-untyped-def]
        ...
        roleSelect = ui.RoleSelect(  # type: ignore[var-annotated]
            placeholder=tanjunLocalizer.localize(
                self.commandInfo.locale,  # type: ignore[misc]
        ...
        roleSelect.callback = self.submit  # type: ignore[method-assign]
        ...
        cancelBtn.callback = self.cancel  # type: ignore[method-assign]
        self.add_item(cancelBtn)
        confirmBtn = discord.ui.Button(  # type: ignore[var-annotated]
            label=tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.confirm"),  # type: ignore[misc]
            style=discord.ButtonStyle.green,
        ...
        confirmBtn.callback = self.confirm  # type: ignore[method-assign]
        self.add_item(confirmBtn)
    ...
    async def submit(self, interaction: discord.Interaction) -> None:
        role_ids = [role for role in interaction.data["values"]]  # type: ignore[index, typeddict-item]
        if len(role_ids) > 1 and not utility.checkIfHasPro(self.commandInfo.guild):  # type: ignore[misc, arg-type]
            await interaction.response.send_message(
...
class VoiceRequirementModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        voice_requirement = int(self.children[0].value)  # type: ignore[attr-defined]
...
class AddChannelRequirementValueModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        value = self.children[0].value  # type: ignore[attr-defined]
...
class AddChannelRequirementView(ui.View):
    ...
    async def on_channel_select(self, interaction: discord.Interaction) -> None:
        self.selected_channels = interaction.data["values"]  # type: ignore[index, typeddict-item]
        await interaction.response.edit_message(
            content=tanjunLocalizer.localize(
                self.commandInfo.locale,  # type: ignore[misc]
...
class RemoveChannelRequirementView(ui.View):
    def __init__(self, commandInfo, view) -> None:  # type: ignore[no-untyped-def]
        ...
        select.callback = self.on_channel_select  # type: ignore[method-assign]
...
class GiveawayBuilder(ui.View):
    def __init__(  # type: ignore[no-untyped-def]  # type: ignore[no-untyped-def]
        self,
        commandInfo,
        title,
        target_channel,
    ...
    async def custom_name(self, interaction: discord.Interaction, button: GiveawayBuilderButton):  # type: ignore[no-untyped-def]
    ...
    async def start_time(self, interaction: discord.Interaction, button: GiveawayBuilderButton):  # type: ignore[no-untyped-def]
        if not utility.checkIfHasPro(self.commandInfo.guild):
            await interaction.response.send_message(
                tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.pro_required"),
                ephemeral=True,
    ...
    async def day_requirement(self, interaction: discord.Interaction, button: GiveawayBuilderButton):  # type: ignore[no-untyped-def]
        if not utility.checkIfHasPro(self.commandInfo.guild):
            await interaction.response.send_message(
                tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.pro_required"),
                ephemeral=True,
    ...
    async def voice_requirement(self, interaction: discord.Interaction, button: GiveawayBuilderButton):  # type: ignore[no-untyped-def]
        if not utility.checkIfHasPro(self.commandInfo.guild):
            await interaction.response.send_message(
                tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.pro_required"),
                ephemeral=True,
    ...
    async def add_channel_requirement(self, interaction: discord.Interaction, button: GiveawayBuilderButton):  # type: ignore[no-untyped-def]
        if not utility.checkIfHasPro(self.commandInfo.guild):
            await interaction.response.send_message(
                tanjunLocalizer.localize(self.commandInfo.locale, "commands.giveaway.builder.pro_required"),
                ephemeral=True,
