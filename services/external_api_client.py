...
class ExternalApiClient:
    ...
    def __init__(self, imgbb_key: str='', giphy_key: str='', github_token: str='', bytebin_url: str='', bytebin_username: str='', bytebin_password: str='') -> None:
    ...
    async def upload_to_imgbb(self, image: bytes, file_extension: str='png') -> ImgBBResponse | None:
        ...
        return ImgBBResponse(id=data.get('id'), url=data.get('url'), display_url=data.get('display_url'), delete_url=data.get('delete_url'))
    ...
    async def upload_to_bytebin(self, data: str) -> str | None:
        ...
        try:
            ...
            async with session.post(self.bytebin_url + '/post', data=compressed_content, headers=headers, auth=auth) as response:
